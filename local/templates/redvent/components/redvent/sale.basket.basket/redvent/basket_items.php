					...
					<tr class="card-list-row" id="<?=$arItem["ID"]?>">
                        ...
                        <td class="card-list-col">
                            <div class="card-list-col-count">
                                ...
                                ?>
                                <a class="card-list-col-count__minus" href="javascript:void(0);" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', <?=$useFloatQuantityJS?>);">-</a>
                                <input
                                ...
                                <a class="card-list-col-count__plus" href="javascript:void(0);" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);">+</a>

...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	...
	<tr>
		...
		{
			?>
			<input type="submit" name="backButton" class="button button-first" value="<?echo GetMessage("SALE_BACK_BUTTON")?>">
			<?
		}
		?>
			<input type="submit" class="button button-first" name="contButton" value="<?= GetMessage("SALE_CONTINUE")?>">
		</td>
	</tr>
</table>
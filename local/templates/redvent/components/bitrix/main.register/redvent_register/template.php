...
<?else:?>
	...
	<form class="form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
		...
		<div class="header-top-personal-popup__field">
			...
			<input class="header-top-personal-popup__text" name="USER_NAME" type="text">
		</div>
		<div class="header-top-personal-popup__field">
			<label class="header-top-personal-popup__name">
				Moбильный телефон
			</label>
			<input class="header-top-personal-popup__text" name="USER_PHONE" type="text">
		</div>
		<div class="header-top-personal-popup__field">
			<label class="header-top-personal-popup__name">
				Электронная почта
			</label>
			<input class="header-top-personal-popup__text" name="USER_EMAIL" type="text">
		</div>
		<div class="header-top-personal-popup__field">
			<label class="header-top-personal-popup__name">
				Пароль
			</label>
			<input class="header-top-personal-popup__text" name="USER_PASSWORD" type="text">
		</div>
		<div class="header-top-personal-popup__field">
			<label class="header-top-personal-popup__name">
				Пароль еще раз
			</label>
			<input class="header-top-personal-popup__text" name="USER_PASSWORD_CONFIRM" type="text">
		</div>
		<div class="header-top-personal-popup__field">
